<?php /* Template Name: QR-Patrol MARS Template */
get_header(); ?>
...
<div class="qr-patrol-inner-page-third-section">
    <div class="inner-page-container">
        <div class="qr-patrol-inner-page-left-right">
            <div class="qr-patrol-inner-page-left-right-text">
...
<!-- <div class="qr-patrol-inner-page-seventh-section">
    <div class="inner-page-container">
        <div class="qr-patrol-inner-page-left-right">
            <div class="qr-patrol-inner-page-left-right-text">
                <h2>Why use QR-Patrol M.A.R.S.</h2>
                <p>QR-Patrol M.A.R.S. is a mobile version of the QR-Patrol application and is developed so as to facilitate guard tour administrators take absolute control over guard tours and ensure assets protection while being on the road. It is almost impossible today to be dedicated on a central computer or laptop without interfering in other tasks that require to leave office. QR-Patrol M.A.R.S. solves this problem by arming security guard tour administrators with a mobile application and real-time notifications while they are outside and cannot wait to get in front of a computer. </p>
            </div>
            <div><img src="/wp-content/uploads/2023/02/qr-mars-seventh-section-image.png"></div>
        </div>
    </div>
</div>
...
<div class="qr-patrol-inner-page-eighth-section">
    <div class="inner-page-container">
        <h2>How will I get QR-Patrol M.A.R.S.?</h2>
        <div class="qr-patrol-mars-eighth-section">
            <div class="qr-patrol-mars-eighth-section-left">
                <h3>QR-Patrol M.A.R.S. User Guide</h3>
                <p>To learn how to manage your guards, sites and checkpoints on the go, consult our newest M.A.R.S User Guide! Even your clients can login and use it! Find out more by clicking the button below!</p>
                <a href="/wp-content/uploads/2023/02/qr-patrol-mars-user-guide.pdf" class="btn-primary">User Guide</a>
            </div>
            <div class="qr-patrol-mars-eighth-section-right">
                <h3>Buy now QR-Patrol M.A.R.S.</h3>
                <p>In case you need to manage your guard tours and monitor guards from your smartphone, just choose a QR-Patrol Patrol PRO plan, which includes QR-Patrol M.A.R.S. application and functionality!</p>
                <a href="../qr-patrol/" class="btn-primary">Buy a PRO plan</a>
            </div>
        </div>
    </div>
</div> -->
