<?php 
    /* Template Name: QR-Patrol Plans Template */
    get_header();
?>
<div class="qr-patrol-plans-page">
        ...
        <table class="price-table">
            <tbody>
                <tr>
                    ...
                    <td class="price-blank"></td>
                    <td class="price-table-popular">Najpopularniji</td>
                    <td class="price-blank"></td>
                </tr>
                <tr class="price-table-head">
                    ...
                    <td>
                        Basic
                        <br><small style="font-size: 12px; font-weight: 400;">Početni plan</small>
                    </td>
                    <td>
                        Pro
                        <br><small style="font-size: 12px; font-weight: 400;">Više daljinskih opcija</small>
                    </td>
                    <td class="green-width">
                        Gold
                        <br><small style="font-size: 12px; font-weight: 400;">Naše kompletno rešenje</small>
                    </td>
                </tr>
                <tr>
    ...
    <div class="mobile-price-table">
        <div class="mobile-basic-plan-card plan-card">
            <h3>Basic Plan</h3>
            <ul>
                <li><i class="fas fa-check"></i> Upravljanje rasporedima</li>
                <li><i class="fas fa-check"></i> NFC/QR-kod kontrolne tačke</li>
                <li><i class="fas fa-check"></i> Dnevni izveštaji o aktivnostima</li>
                <li><i class="fas fa-check"></i> + "Beacons" kontrolna tačka</li>
                <li><i class="fas fa-check"></i> Geolokacija</li>
                <li><i class="fas fa-check"></i> GPS praćenje</li>
                <li><i class="fas fa-check"></i> Upozorenja u realnom vremenu</li>
                <li><i class="fas fa-check"></i> Upravljanje korisnicima</li>
        ...
        <h3>Pro Plan</h3>
            <ul>
                ...
                <li><i class="fas fa-check"></i> Pristup na više nivoa</li>
                <li><i class="fas fa-check"></i> Email obaveštenja</li>
                <li><i class="fas fa-check"></i> Upravljanje telefonom</li>
                <li><i class="fas fa-check"></i> Push to talk funkcionalnost</li>
                <li><i class="fas fa-check"></i> API pristup</li>
                <li><i class="fas fa-check"></i> Eksterno SOS dugme</li>
                <li><i class="fas fa-check"></i> Unutrašnja lokacija</li>
                <li><i class="fas fa-check"></i> Čovek pao funkcionalnost</li>
        ...
        <h3>Gold Plan</h3>
            ...
            <li><i class="fas fa-check"></i> Upravljanje rasporedima</li>
                ...
                <li><i class="fas fa-check"></i> Mobilne forme</li>
                <li><i class="fas fa-check"></i> Verifikacija licem</li>
                <li><i class="fas fa-check"></i> Trag patrole čuvara</li>
                <li><i class="fas fa-check"></i> Personalizovani ekran za prijavu</li>
                <li><i class="fas fa-check"></i> Safepass</li>
                <li><i class="fas fa-check"></i> Logo na izveštajima i slike čuvara</li>
                <li><i class="fas fa-check"></i> Virtuelne kontrolne tačke</li>
